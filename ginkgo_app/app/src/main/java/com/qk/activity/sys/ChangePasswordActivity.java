...
public class ChangePasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        oldPwd = findViewById(R.id.edit_old_password);
     ...
     * 修改密码
     */
    private void submit(final String oldPwd,final String newPwd, final String confirmPwd) {
        if(TextUtils.isEmpty(oldPwd)){
            Toast.makeText(this, Constant.EMPTY_OLD_PASSWORD,Toast.LENGTH_SHORT).show();
            return;
        }
