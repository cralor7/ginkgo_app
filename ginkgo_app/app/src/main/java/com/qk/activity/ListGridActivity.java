...
import com.qk.R;
import com.qk.adapter.MyBaseExpandableListAdapter;
import com.qk.girdview.NextActivity;
...
public class ListGridActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_2_next_function = findViewById(R.id.btn_2_next_function);
        btn_2_next_function.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListGridActivity.this, NextActivity.class);
